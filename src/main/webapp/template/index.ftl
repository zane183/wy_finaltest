...
<div class="g-doc">
    ...
    <div id="pageset"> 
	<input data-pre="${page.pagenumber-1}" type="button" value="上一页" class="u-btn u-btn-primary u-btn-lg">
    <input data-next="${page.pagenumber+1}" type="button" value="下一页" class="u-btn u-btn-primary u-btn-lg"></div>
    </#if>
